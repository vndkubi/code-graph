...
const TREE_SITTER_PROVIDER_VERSION = 'tree-sitter-analyzer-v18-default-field-usages';
const TREE_SITTER_FIELD_USAGE_DISABLED_PROVIDER_VERSION = 'tree-sitter-analyzer-v18-field-usages-disabled';
