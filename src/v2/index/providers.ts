...
const TREE_SITTER_PROVIDER_VERSION = 'tree-sitter-analyzer-v25-spring-array-paths-default-field-usages';
const TREE_SITTER_FIELD_USAGE_DISABLED_PROVIDER_VERSION = 'tree-sitter-analyzer-v25-spring-array-paths-field-usages-disabled';
